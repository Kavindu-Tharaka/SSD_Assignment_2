...
//end point to upload images to the google drive
//request body will contain the url of the image
//if success 200 status code will be sent as the response to the client
//if there is an error status code of 400 will be sent to the client side
